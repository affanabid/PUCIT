...
class BinarySearchTree:
    ...
    def construct_from_traversals(self, in_order, pre_order):
        ...
        self.root, extraed = self.build_tree(0, len(in_order) - 1, 0)
        return self.root
    
    def build_tree(self, in_start, in_end, pre_start):
        if in_start > in_end:
        ...
        root.left, pre_start = self.build_tree(in_start, in_index - 1, pre_start)
        root.right, pre_start = self.build_tree(in_index + 1, in_end, pre_start)
